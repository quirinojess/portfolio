...
import jess from "../../assets/img/jess.png";
import {
 goToAbout,
 goToHomePage,
 goToProjects,
...
function Navigation() {
 ...
 return (
  <>
   <Main>
    <Photo>
     <img onClick={() => goToAbout(history)} src={jess} alt="Jessica Quirino" />
    </Photo>

    <Name>Jess</Name>

    <Navbar>
     <NavItem onClick={() => goToHomePage(history)}>
      <svg
     ...
     <NavItem onClick={() => goToProjects(history)}>
      <svg
       xmlns="http://www.w3.org/2000/svg"
     ...
     <NavItem>
      <a
       target="_blank"
       href="https://github.com/quirinojess/"
       rel="noreferrer"
      >
       <svg
        xmlns="http://www.w3.org/2000/svg"
